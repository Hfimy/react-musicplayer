...
class App extends Component {
  ...
  playMusic(musicItem,playState='play') {
  ...
  playToggle(playState,type = 'next') {
  ...
  componentDidMount() {
    ...
    Pubsub.subscribe('PLAY_PREV', (msg,playState) => {
      console.log(playState)
      this.playToggle(playState,'prev')
    })
    Pubsub.subscribe('PLAY_NEXT', (msg,playState) => {
      this.playToggle(playState,'next')
    })
